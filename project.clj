...
(defproject xyz.zcaudate/foundation-web "4.0.6"
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [xyz.zcaudate/js.cell             "4.0.6"]
                 [xyz.zcaudate/js.lib.datetime     "4.0.6"]
                 [xyz.zcaudate/js.lib.ethereum     "4.0.6"]
                 [xyz.zcaudate/js.lib.rn           "4.0.6"]
                 [xyz.zcaudate/js.lib.lw-charts    "4.0.6"]
                 [xyz.zcaudate/js.lib.valtio       "4.0.6"]
                 [xyz.zcaudate/js.react            "4.0.6"]
                 [xyz.zcaudate/js.react-ext        "4.0.6"]
                 [xyz.zcaudate/js.react-native     "4.0.6"]
                 
                 [xyz.zcaudate/jvm                 "4.0.6"]
                 [xyz.zcaudate/net.http            "4.0.6"]

                 [xyz.zcaudate/rt.basic            "4.0.6"]
                 
                 [xyz.zcaudate/script.css          "4.0.6"]
                 [xyz.zcaudate/script.sql          "4.0.6"]
                 [xyz.zcaudate/std.lib             "4.0.6"]
